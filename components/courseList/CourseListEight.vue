          ...
          <div class="row y-gap-20 items-center justify-between pb-30">
            <div class="col-auto">
              <div class="text-14 lh-12">
                Showing{{ " " }} <span class="text-dark-1 fw-500"> 65 </span
                >{{ " " }}
                total results
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div class="coursesCard__content pl-20 sm:pl-10 pr-10">
              ...
              <div
                class="d-flex justify-between items-center pt-10 border-top-light"
              >
                <div class="d-flex items-center">
                  <nuxt-img
                    :width="30"
                ...
                <div class="d-flex items-center">
                  <div
                    v-if="elm.paid"
                    class="text-light-1 fw-500 mr-10 line-through"
                  >
                    ${{ elm.originalPrice }}
                  </div>
                  <div v-if="elm.paid" class="text-18 fw-500 text-dark-1">
                    ${{ elm.discountedPrice }}
                  </div>
