          ...
          <div class="row y-gap-30 relative">
            <div class="col-xl-7 col-lg-8">
              <div class="d-flex x-gap-15 y-gap-10 pb-20">
                ...
                <div>
                  <div
                    class="badge px-15 py-8 text-11 bg-blue-1 text-white fw-400"
                  >
                    POPULAR
                  </div>
                </div>
              ...
              <p class="col-xl-9 mt-20 text-white">
              ...
              >
                <div class="d-flex items-center text-white">
                  <div class="text-14 lh-1 text-green-1 mr-10">
                    {{ pageItem.rating }}
                  </div>
              ...
              <div class="d-flex items-center pt-20">
                ...
                ></div>
                <div class="text-14 lh-1 ml-10 text-white">
                  {{ pageItem.authorName }}
                </div>
              </div>
            </div>
