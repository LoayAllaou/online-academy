        ...
        <div class="col-xl-10">
          <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
            ...
            <div class="py-30 px-30">
              ...
              <div class="mt-30">
                <div
                  v-for="(item, index) in gradingSummary"
                  :key="index"
                  :class="[index % 2 === 0 ? 'bg-light-4' : '']"
                >
                  <div class="rounded-8 px-25 py-25">
                    <div class="row">
                      <div class="col-3">
                        <div class="text-dark-1">{{ item.label }}</div>
                      </div>
                      <div class="col-auto">
                        {{ item.value }}
                      </div>
              ...
              <div
                class="d-flex x-gap-30 flex-wrap y-gap-10 justify-center items-center mt-30"
              >
                <div>
              ...
              <div
                class="d-flex flex-wrap y-gap-10 justify-between items-center mt-40"
              >
                ...
                <div
                  ...
                  :class="`dropdown js-dropdown js-category-active ${
                    isDropdownActive ? '-is-dd-active' : ''
                  }`"
                >
                  <div
                    class="dropdown__button d-flex items-center text-14 bg-white -dark-bg-dark-1 border-light rounded-8 px-20 py-10"
                  ...
                  <div
                    :class="`toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-category-toggle ${
                      isDropdownActive ? '-is-el-visible' : ''
                    }`"
                  >
...
const gradingSummary = [
  ...
  { label: "Needs grading", value: "1" },
  { label: "Due date", value: "Thursday, 26 December 2019, 1:00 AM" },
  { label: "Time remaining", value: "Assignment is due" },
];

const categories = [
  { id: 1, name: "Animation", link: "animation" },
  { id: 2, name: "Design", link: "design" },
  { id: 3, name: "Illustration", link: "illustration" },
